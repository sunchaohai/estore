					...
					<div class="userCenterBox boxCenterList clearfix"
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<c:forEach items="${order.oiList}" var="orderitem">
								<tr>
									<td>
										<a href="javascript:;" class="f6">${orderitem.good.name}</a>
									</td>
									<td>${orderitem.good.marketprice}元</td>
									<td>${orderitem.good.estoreprice}元</td>
									<td align="center">${orderitem.buynum}</td>
									<td>${orderitem.good.estoreprice * orderitem.buynum}元</td>
								</tr>
							</c:forEach>
							...
							<tr>
								<td colspan="5" style="text-align:right;padding-right:10px;font-size:25px;">
									...
									<a href="${root}/pay.jsp?totalPrice=${order.totalprice}&oid=${order.id}"><input value="确认支付" type="button" class="btn" /></a>
								</td>
							</tr>
						</table>
					</div>
