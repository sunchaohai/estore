				...
				<div class="block">
					<div class="f_l left_login">
						...
						<c:if test="${not empty loginUser}">
							<font id="ECS_MEMBERZONE"> 欢迎光临本店:${loginUser.nickname}
					...
					<div class="header_r">
						<a href="${root}/servletOrderList">我的订单</a>
						<a href="${root}/servletGoodsList">商品列表</a>
					</div>
				</div>
			</div>
		</div>
			...
			<ul class="cart_info">
				<li id="ECS_CARTINFO">
					<div class="top_cart">
						...
						<a href="${root}/servletCartList" class="shopborder">去购物车结算</a>
					</div>
				</li>
			</ul>
		</div>
